...
public class ImageCodeGenerator implements ValidateCodeGenerator {
    ...
    public ImageCode createImageCode ( HttpServletRequest request ) {
        ...
        String sRand = "";
        for (int i = 0; i < securityProperties.getCodeProperties().getImage().getLength(); i++) {
        ...
        g.dispose();
        return new ImageCode(image,sRand ,securityProperties.getCodeProperties().getImage().getExpireIn() );
    }
